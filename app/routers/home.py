...
def home(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("index.html", {"request": request, "news": latest_news, "activities": upcoming})
...
def activities_page(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("activities.html", {"request": request, "activities": items})
